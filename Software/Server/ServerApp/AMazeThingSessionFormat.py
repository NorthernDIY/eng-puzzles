...
#Session MetaData
SessionObject = {ID:-1, IP:"0.0.0.0:7777", ST:-1, ET:-1, ABS:-1,
...
DBSessionObjectTags = (ID,IP,ST,ET,ABS,AST,HBS,HST,HMA,HRT,HZ,NHS,FWV,BPC,SC,DBG_KPT,DBG_SS,DBG_SE)
DBSessionObjectTagTypes = ("INTEGER","TEXT","TEXT","TEXT","INTEGER","INTEGER","INTEGER","INTEGER","INTEGER",
                            "INTEGER","INTEGER","INTEGER","TEXT","INTEGER","INTEGER","INTEGER","INTEGER","INTEGER")

SessionObjectTags = (ID,IP,ST,ET,ABS,AST,HBS,HST,HMA,HRT,HZ,NHS,FWV,BPC,SC,DBG_KPT,DBG_SS,DBG_SE,SQP,SQC,SC,LHS,LAS,LDT)
